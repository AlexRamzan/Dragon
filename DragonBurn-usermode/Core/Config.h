...
namespace MenuConfig
{
	...
	inline std::string version = "3.4.7.0";
...
namespace LegitBotConfig
{
	...
	inline bool AdvancedPrediction = true;
	inline bool IntelligentTargeting = true;
	inline bool WallAvoidance = true;
	inline bool WeaponAdaptive = true;
	inline bool UltraLowLatency = true;
	inline bool HeadshotPriority = true;
	inline bool DynamicFOV = true;
	inline bool AntiDetection = true;
	
	// Prediction Settings
	inline float PredictionTime = 0.1f; // 100ms prediction
	inline int HistorySize = 10;
	inline float VelocityThreshold = 50.0f;
	inline float ThreatMultiplier = 2.0f;
	
	// Performance Settings
	inline float MaxPredictionDistance = 2000.0f;
	inline float MinTargetHealth = 1;
	inline float MaxTargetHealth = 100;
	inline float WallCheckDistance = 1000.0f;
	
	// Advanced Smoothing
	inline bool WeaponSpecificSmoothing = true;
	inline float SniperSmoothFactor = 0.5f;
	inline float RifleSmoothFactor = 0.8f;
	inline float PistolSmoothFactor = 1.2f;
	inline float SMGSmoothFactor = 1.0f;
	
	// Anti-Detection
	inline bool AdvancedHumanization = true;
	inline float MicroJitterStrength = 0.3f;
	inline float ReactionTimeVariation = 0.15f;
	inline bool CurvedMovement = true;
	inline bool VelocityBasedSmoothing = true;
}
...
namespace ESPConfig
{
	...
	inline bool GlowHack = false;
	inline bool RadarHack = false;
	inline float GlowTimeOn = 86400.f;
